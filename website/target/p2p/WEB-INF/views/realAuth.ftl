	...
	<head>
		...
		<script type="text/javascript">
		  ...
		  $(function(){
			  ...
			  //上传身份证正面图片
			  //将上传身份证正面的a标签变成一个uploadify的组件
			  $("#uploadBtn1").uploadify({
				  buttonText:"上传正面图片",
				  fileObjName:"file", //定义上传文件的名字
				  fileTypeDesc:"身份证正面图片",
				  fileTypeExts:"*.gif; *.png; *.jpg",
				  multi:false,
				  swf:"/js/plugins/uploadify/uploadify.swf", //通过网络的方式来访问
				  uploader:"/reaAuthUpload.do" , //后台处理文件的地址
			  ...
			  $("#realAuthForm").ajaxForm(function(){
				  //提供上传成功的提示，并刷新页面
				  $.messager.confirm("提示","实名认证申请成功!",function(){
