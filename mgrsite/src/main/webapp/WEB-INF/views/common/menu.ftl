<ul id="menu" class="list-group">
	<li class="list-group-item"><a href="#" data-toggle="collapse"
		data-target="#usermanage_detail"><span>用户管理</span></a>
	...
	<li class="list-group-item"><a href="#" data-toggle="collapse"
		data-target="#permissionmanage_detail"><span>安全管理</span></a>
		<ul class="in" id="permissionmanage_detail">
			<li class="systemDictionary"><a href="/systemDictionary_list.do"><span>系统数据字典目录</span></a></li>
			<li class="systemDictionaryItem"><a
				href="/systemDictionaryItem_list.do"><span>系统数据字典明细</span></a></li>
	...
	<li class="list-group-item"><a href="#" data-toggle="collapse"
		data-target="#auditmanage_detail"> <span>审核项目</span>
	</a>
		<ul class="in" id="auditmanage_detail">
			...
			<li class="bidrequest_publishaudit_list"><a
				href="/bidrequest_publishaudit_list.do">发标前审核</a></li>
			<li class="bidrequest_audit1_list"><a
				href="/bidrequest_audit1_list.do">满标一审</a></li>
			<li class="bidrequest_audit2_list"><a
				href="/bidrequest_audit2_list.do">满标二审</a></li>
			<li class="rechargeOffline"><a href="/rechargeOffline.do">线下充值审核</a></li>
			<li class="moneyWithdraw"><a href="/moneyWithdraw.do">提现审核</a></li>
		</ul></li>
	<li class="list-group-item"><a href="#" data-toggle="collapse"
		data-target="#systemmanage_detail"> <span>平台管理</span>
	</a>
