...
<body>
			...
			<div class="col-sm-9">
				...
				<div class="row">
					...
					<form id="searchForm" class="form-inline" method="post"
						action="systemDictionary_list.do">
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								<td>${vo.title}</td>
								<td>${vo.sn}</td>
								<td><a href="javascript:void(-1);" class="edit_Btn" data-jsonstr='${vo.jsonString}'>修改</a></td>
							</tr>
							</#list>
						</tbody>
					</table>
	...
	<div id="systemDictionaryModal" class="modal" tabindex="-1"
		role="dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="editForm" class="form-horizontal" method="post"
						action="/systemDictionary_update.do" style="margin: -3px 118px">
